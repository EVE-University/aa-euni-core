...
def migrate_service_enabled(apps, schema_editor):
    ...
    ).exists() or getattr(settings, "ENABLE_BLUE_FORUM", False):
        try:
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={
                "permissions": (
                    ("access_euni_phpbb3", "Can access the phpBB3 service"),
                )
            },
        ),
