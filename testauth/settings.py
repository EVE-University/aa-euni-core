...
# - absolute urls eg 'http://eunicore.com/dashboard'
...
# to https://eunicore.com/sso/callback substituting your domain for eunicore.com
...
# Set the default from email to something like 'noreply@eunicore.com'
